...
//            logger.info("ProcessTrainNeuralNetByTrend " + LockName + " unlock LockName");
    ...
    public void TrainNN40NeuralNetByTrend(ServiceAFweb serviceAFWeb, String symbol, int TR_NN, ArrayList stockNNprocessNameArray) {
        String LockStock = "NN40_TR_" + symbol; // + "_" + trNN;
        LockStock = LockStock.toUpperCase();
...
//            }
            ...
            if (trainInFile == true) {
                inputDatalist = GetNN40InputBasefromDB(serviceAFWeb, "", subSymbol, nnName);
...
//                    logger.info("> NeuralNetAllStock " + BPnameSym + " " + inputDatalist.size());
    ...
    public ArrayList<NNInputDataObj> GetNN40InputBasefromDB(ServiceAFweb serviceAFWeb, String symbol, String subSymbol, String nnName) {
