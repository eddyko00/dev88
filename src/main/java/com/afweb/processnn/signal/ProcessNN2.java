...
//        logger.info("> trainingNN2 ");
        ...
        TradingRuleObj trObjNN2 = serviceAFWeb.getAccountStockTRByTRnameServ(username, null, accountid, symbol, TRname);
...
//        ArrayList<NNInputOutObj> inputlist = new ArrayList<NNInputOutObj>();
        ...
        NNTrainObj nnTrSym = new NNTrainObj();
        TradingRuleObj trObjNN2 = serviceAFWeb.getAccountStockTRByTRnameServ(username, null, accountid, symbol, ConstantKey.TR_NN2);
