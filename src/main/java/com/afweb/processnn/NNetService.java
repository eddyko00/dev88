            ...
            if (serviceAFWeb.processRestAllStockflag == true) {
                ...
                if (accountAPIObjL != null) {
                    if (accountAPIObjL.size() > 0) {
                        ...
                        APIStockNameList = serviceAFWeb.AccGetAccountStockNameListServ(accountAPIObj.getId());
                    }
                }
...
////////////////////////////////
                // Add or remove stock
                AccountObj accountAPIObj = accountAPIObjL.get(0);
                ArrayList<String> APIStockNameList = serviceAFWeb.AccGetAccountStockNameListServ(accountAPIObj.getId());
