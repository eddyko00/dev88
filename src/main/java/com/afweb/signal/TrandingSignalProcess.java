        ...
        while (offset > offsetInput) {
            ...
            switch (trObj.getType()) {
                ...
                case ConstantKey.INT_TR_BB:
                    ...
                    trHistory.setTrsignal(trObj.getTrsignal());
                    trHistory.setParm1((float) bbObj.perlowerBandValue);
                    trHistory.setParm2((float) bbObj.perupperBandValue);
                    trHistory.setParm3((float) bbObj.lastperlowerBandValue);
                    trHistory.setParm4((float) bbObj.lastperupperBandValue);
                    break;
...
//            logger.info("> initTrainingNeuralNet1 " + nnFileName);
    ...
    public ArrayList<NNInputDataObj> getTrainingInputDataFromFile(ServiceAFweb serviceAFWeb, String nnName, HashMap<String, ArrayList> stockInputMap) {
        ArrayList<NNInputDataObj> inputlist = new ArrayList();
        ArrayList<NNInputDataObj> inputlistRet = new ArrayList();
        String symbol = "";
