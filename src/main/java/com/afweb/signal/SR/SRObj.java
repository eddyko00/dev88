...
//    void supportResistance(ArrayList<AFstockInfo> ntp) {
...
//        double ltp_s = smooth(ntp, (n + 1), 3);
////      # taking a simple derivative
//    double [] ltp_d = {0};
//    
//    ltp_d[0] = np.subtract(ltp_s[1:], ltp_s[:-1])
//
//    }
//
//    private double smooth(ArrayList<AFstockInfo> ntp, int offset, int len) {
//        return 0;
//    }
//
...
//    }
//
//    public static double DIFF_PERC_FROM_EXTREME = 0.2;  //???    
