...
//        ArrayList<NNInputOutObj> inputlist = new ArrayList<NNInputOutObj>();
    ...
    int ProcessTRHistoryOffsetNN3(ServiceAFweb serviceAFWeb, TradingRuleObj trObj, ArrayList<AFstockInfo> StockArray, int prevSignal,
...
//    
    ...
    public boolean Rule0_CheckNN(ServiceAFweb serviceAFWeb, NNObj nn, AccountObj accountObj,
        ...
        NNObj nnTmp = NNCal.NNpredict(serviceAFWeb, ConstantKey.INT_TR_NN3, accountObj, stock, StockArray, offset);
    ...
    public static float NN3StopLoss = 7; //5; //16;  // 20
    // check stop loss
        ...
        if (nn != null) {
            ...
            if ((CKey.PREDICT_THRESHOLD > output1) && (CKey.PREDICT_THRESHOLD > output2)) {
                ...
                for (int i = 0; i < 5; i++) {
                    ...
                    NNObj NN3 = NNCal.NNpredict(serviceAFWeb, ConstantKey.INT_TR_NN30, accountObj, stock, StockArray, offset + 1 + i);
                    if (NN3 != null) {
