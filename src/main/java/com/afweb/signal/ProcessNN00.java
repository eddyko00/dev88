...
//    public static final int INT_MACD0_2 = 2;
    ...
    //StockArray assume recent date to old data
    //StockArray assume recent date to old data   
    public ArrayList<NNInputDataObj> trainingNN00_1dataEMA1(ServiceAFweb serviceAFWeb, String sym, ArrayList<AFstockInfo> StockArray, int offset, int monthSize) {
        NN2ProcessByTrend NNProcessTrend = new NN2ProcessByTrend();
        TrandingSignalProcess TRprocessImp = new TrandingSignalProcess();
//        logger.info("> trainingNN ");
...
//        ArrayList<NNInputOutObj> inputlist = new ArrayList<NNInputOutObj>();
        ...
        // TR_NN1
        trObjMACD1.setTrname(ConstantKey.TR_MACD1);
        trObjMACD1.setType(ConstantKey.INT_TR_EMA1);
        trObjMACD1.setAccount(trObjMACD.getAccount());
        trObjMACD1.setStockid(trObjMACD.getStockid());
...
//        }
    ...
    public ArrayList<NNInputDataObj> trainingNN00_0dataEMA2(ServiceAFweb serviceAFWeb, String sym, ArrayList<AFstockInfo> StockArray, int offset, int monthSize) {
        NN2ProcessByTrend NNProcessTrend = new NN2ProcessByTrend();
        TrandingSignalProcess TRprocessImp = new TrandingSignalProcess();
//        logger.info("> trainingNN ");
